                ...
                <!-- para los flasshh messages en bootstrap -->        
                   @include('flash::message')
					...
					<div class="box-header with-border">
						...
						<i class="fa fa-plus-square" aria-hidden="true"></i> <a href="{{ route('admin.usuarios.create')}}">Agregar</a></button>
...
<div class="box-body">
                        <div class="table_mostrar_scroll_xs">
                            <div id="example1_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer"><div class="row"><div class="col-sm-6"></div><div class="col-sm-6"></div></div><div class="row"><div class="col-sm-12"><table id="example1" class="table table-bordered table-striped dataTable no-footer" role="grid">
                                <thead>
                                <tr role="row">
                                  ...
                                  <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Pagina: activate to sort column ascending" style="width: 0px;">ROL</th>
                                  <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="URL-SEO: activate to sort column ascending" style="width: 0px;">USUARIO</th>
                                  <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="URL-web: activate to sort column ascending" style="width: 0px;">CORREO</th><th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Acciones: activate to sort column ascending" style="width: 0px;">Acciones</th></tr>
                                </thead>
                                <tbody>
                                ...
                                <tr role="row" class="odd">
                                    ...
                                    <td>
                                    <a href="javascript:eliminarRegistro(1)">email me</a>

                                                                                    <a href="/tienda/paginas/update/18?update=1&amp;portada=1" data-toggle="tooltip" data-placement="top" title="Establecer como portada">
                                              <span class="label label-default">Poner Portada</span></a>
                                            
                                        |


                                        <a href="{{ route('admin.usuarios.edit',$row->id) }}" data-toggle="tooltip" data-placement="top" title="Editar" class="btn btn-primary btn-xs"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a> |

                                        <a href="javascript:eliminarRegistro('{{ route('admin.usuarios.destroy',$row->id) }}')" data-toggle="tooltip" data-placement="top" title="Eliminar" class="btn btn-primary btn-xs"><span class="glyphicon glyphicon-remove-sign" aria-hidden="true"></span></a></td>
                                  </tr>
                                  @endforeach
