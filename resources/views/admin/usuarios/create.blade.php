		...
		<div class="row">
			...
			<div class="col-md-12">
				...
				<div class="box">
					...
					{!! Form::open(['url' => 'admin/usuarios','method' => 'post', 'files' => true,'class' => 'bordered-row','id' => 'formulario','name' => 'formulario','role' => 'form']) !!}
					...
					<div class="box-body">
						...
						<div class="form-group">
							...
							{!! Form::text('usuario',null,['class' => 'form-control required','id' => 'usuario','placeholder'=>"Nombre"]) !!}
						</div>


						<div class="form-group">
							{!! Form::label('correo', 'Correo') !!}
							{!! Form::text('correo',null,['class' => 'form-control required','id' => 'correo','placeholder'=>"email@hhh.com"]) !!}
						</div>

						<div class="form-group">
							{!! Form::label('password', 'Password') !!}
							{!! Form::password('pass',['class' => 'form-control required','id' => 'pass','placeholder'=>"****"]) !!}
						</div>
