    ...
    Jconfirm.prototype = {
        ...
        _setButtons: function () {
            ...
            $.each(this.buttons, function (key, button) {
                ...
                //var botonText2 = bbbbb.replace('Microsoft', 'W3Schools');
				...
				textBotoon=that.buttons[key].text;
				textBotoon = textBotoon.replace('confirm', 'si');
				textBotoon = textBotoon.replace('cancel', 'no');
					//console.log(textBotoon);
				var button_element = $('<button type="button" class="btn ' + that.buttons[key].btnClass + '">' + textBotoon + '</button>').click(function (e) {
                    e.preventDefault();
